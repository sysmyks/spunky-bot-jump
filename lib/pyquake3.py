...
class PyQuake3(object):
    ...
    def __init__(self, server, rconpassword=''):
        ...
        self.set_rcon_password(rconpassword)
    ...
    def set_rcon_password(self, rconpassword):
        """
        set RCON password
        """
    ...
    def rcon(self, cmd):
        ...
        send RCON command
        """
        r_cmd = self.command('rcon "%s" %s' % (self.rconpassword, cmd))
...
if __name__ == '__main__':
    ...
    QUAKE = PyQuake3(server='localhost:27960', rconpassword='secret')
