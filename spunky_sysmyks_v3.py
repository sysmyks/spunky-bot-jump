...
# senior admin level 80
            ...
            # rebuild - sync up all available maps
                ...
                mapcycle_txt = CONFIG.get('server', 'mapcycle_txt')
                ...
                random.shuffle(mapcycle_entries)
                # Write map names to the specified mapcycle_txt file
                with open(mapcycle_txt, 'w') as txt_file:
                    for map_name in mapcycle_entries:
                        txt_file.write(map_name + "\n")
